...
const uint8_t usedFlag = 1;         // 0
const uint8_t generatedFlag = 2;	// 1
const uint8_t canBeUpdatedFlag = 4; // 2
const uint8_t showFlag = 8;			// 3 @TODO: use it
...
public: // Variables
	...
	uint8_t flags = canBeUpdatedFlag;
