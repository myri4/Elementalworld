...
namespace wc {
	...
	public:
		...
		void Create(const std::string& path) {
			...
			// ids
			m_VertexArray.VertexAttribPointer(3, 4, offsetof(MeshVertex, m_BoneIDs));
			// weights
			m_VertexArray.VertexAttribPointer(4, 4, offsetof(MeshVertex, m_Weights));

			m_VertexArray.BindingDivisor(0, 0);
			m_VertexArray.BindingDivisor(1, 0);
			m_VertexArray.BindingDivisor(2, 0);
			m_VertexArray.BindingDivisor(3, 0);
			m_VertexArray.BindingDivisor(4, 0);
			...
			m_VertexArray.SetVertexBuffer(m_VertexBuffer, sizeof(MeshVertex));
